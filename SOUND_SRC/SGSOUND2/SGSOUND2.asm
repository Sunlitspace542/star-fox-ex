...
spcblock !BASE_ADDR nspc
	...
	%SMPL_PTR(!engine_snd, $0000)			; 20 Reserved for player's engine sound and will be overwritten at runtime
...
spcblock EXT_SONG_Fanfare_Orchestra_F8D3 nspc
	%INC_SONG(Fanfare_Orchestra_F9F1)		; Fanfare (Orchestra)
;endspcblock
;spcblock EXT_SONG_Player_Down_Orchestra_FCF0 nspc
	%INC_SONG(Player_Down_Orchestra_FE0E)	; Player Down (Orchestra)
endspcblock
...
spcblock !BASE_ADDR nspc
	...
	dw $0000								; NULL
	dw $0000								; NULL
	dw Fanfare_Orchestra_F9F1				; sub 7 fanfare (orchestra) SGSOUND2
	dw $0000								; NULL
	dw $0000								; NULL
	dw $0000								; NULL
	...
	dw $0000								; NULL
	dw Player_Down_Orchestra_FE0E			; sub 17 player down (orchestra)
