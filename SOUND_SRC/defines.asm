...
!sampl_data = $4000 		; Sample data base address
...
!gft = $FEDE ;$fdc0				; Song table base address
!engine_snd = $FF04			; Location of noise BRR generated for Arwing's engine sound in ARAM